    ...
    <div className="about">
      ...
      <div className="about__content">
        ...
        <div className="about__content-text">
          <p>
            I'm {new Date().getFullYear() - 1999} years old CS student at
            Politechnika Częstochowska. I'm intrested in technology and
            programming.
          </p>
          <ul>
            ...
            <li>Swimming,</li>
            <li>
              Playing games (I love Rocket League <span role="img">❤️</span>)
            </li>
          </ul>
        </div>
      </div>
