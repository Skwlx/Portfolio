    ...
    <footer>
      <div className="footer__content">
        ...
        <ul className="footer__social-list">
          ...
          <li>
            <a
              href="mailto:pawel.slawuta@o2.pl"
              className="footer__social-list-icon"
            >
          ...
          <li>
            <a
              href="https://www.facebook.com/profile.php?id=100005753820598"
              className="footer__social-list-icon"
            >
          ...
          <li>
            <a
              href="https://www.linkedin.com/in/paweł-sławuta-64709219a/"
              className="footer__social-list-icon"
            >
